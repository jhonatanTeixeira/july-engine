...
WHEELS_DIR="vendor/july_engine_libs/python/llama_gguf/vendor/llama-cpp-python/dist"
SUBMODULE_DIR="vendor/july_engine_libs/python/llama_gguf/vendor/llama-cpp-python"
